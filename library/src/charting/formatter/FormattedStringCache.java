...
public class FormattedStringCache {
    ...
    public static class Generic<K,V> extends FormattedStringCache{
        ...
        private HashMap<K, String> mCachedStringsHashMap = new HashMap<K, String>();
        private HashMap<K, V> mCachedValuesHashMap = new HashMap<K, V>();
    ...
    public static class PrimIntFloat extends FormattedStringCache{
        ...
        private ArrayList<Float> cachedValues = new ArrayList<Float>();
        private ArrayList<String> cachedStrings = new ArrayList<String>();
    ...
    public static class PrimDouble extends FormattedStringCache{
        ...
        private ArrayList<Double> cachedValues = new ArrayList<Double>();
        private ArrayList<String> cachedStrings = new ArrayList<String>();
