...
public class PieChartRenderer extends DataRenderer {
    ...
    private TextPaint mCenterTextPaint_des;
    ...
    private StaticLayout mCenterTextLayout_num;
    ...
    public PieChartRenderer(PieChart chart, ChartAnimator animator,
        ...
        mCenterTextPaint_des = new TextPaint(Paint.ANTI_ALIAS_FLAG);
        mCenterTextPaint_des.setColor(Color.GRAY);
        mCenterTextPaint_des.setTextSize(Utils.convertDpToPixel(12f));
    ...
    protected void drawCenterText(Canvas c) {
        ...
        CharSequence centerText_num = mChart.getAmountTotal();

        if (mChart.isDrawCenterTextEnabled() && centerText != null&&centerText_num!=null) {
            ...
            if (!centerText.equals(mCenterTextLastValue) || !boundingRect.equals(mCenterTextLastBounds)) {
                ...
                mCenterTextLayout = new StaticLayout(centerText_num.toString(), 0, (centerText_num.toString()).length(),
                        mCenterTextPaint,
                        (int) Math.max(Math.ceil(width), 1.f)/*centerText_num.length()*/,
                        Layout.Alignment.ALIGN_CENTER, 1.f, 0.f, false);
                mCenterTextLayout_num = new StaticLayout(centerText, 0, centerText.length(),
                        mCenterTextPaint_des,
...
//            float layoutWidth = Utils.getStaticLayoutMaxWidth(mCenterTextLayout);
            ...
            c.translate(boundingRect.left, boundingRect.top + (boundingRect.height() - layoutHeight-layoutHeight-5) / 2.f);
            mCenterTextLayout.draw(c);
            c.restore();
            c.translate(boundingRect.left, boundingRect.top + (boundingRect.height() - layoutHeight+layoutHeight+5) / 2.f);
            mCenterTextLayout_num.draw(c);
