...
public abstract class MonthView extends View {
    ...
    private IMouthChange changeClick;
...
//        rowSize = getHeight() * 1.0F / NUM_ROWS;
    ...
    // 设置展示月份数量
    public void setMonthState(int showMonthNum){
        this.showMonthNum = showMonthNum;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        int leftNum = (selYear - currYear)*12 + selMonth - currMonth;
        int rightNum = (selYear - currYear)*12 + selMonth - currMonth+1;
        switch(eventCode){
...
//                if(isSelect){
                ...
                if(leftNum>0&&rightNum<showMonthNum){
...
//                }
    ...
    private void setLeftDate(){
        ...
        int day = selDay;
        int leftNum = 0;
        leftNum = (selYear - currYear)*12 + selMonth - currMonth;
        if(leftNum>0){
    ...
    private void setRightDate(){
        ...
        int day = selDay;
        int right = 0;
        right = (selYear - currYear)*12 + selMonth - currMonth;
        if(right<showMonthNum){
    ...
    public void setPositionDate(int year,int month,int day){
    ...
    private void computeDate(){
        ...
        //执行activity发送过来的切换月份事件
        if(changeClick != null){
            changeClick.setDataInfo(selYear,selMonth + 1,selDay);
        }
    ...
    public void setDateChange(IMouthChange changeClick) {
    ...
    public interface IMouthChange{
        void setDataInfo(int year, int month, int day);
    }
