...
public class CxyTestClassListAdapter extends RecyclerBaseAapter<RecyclerView.ViewHolder> {
    private MouldList<ResultClassIndexItemBean> arrayList;

    public CxyTestClassListAdapter(Context context, MouldList<ResultClassIndexItemBean> arrayList) {
        super(context);
