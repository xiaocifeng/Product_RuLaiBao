 ...
 *  待发佣金 Adapter 类
 */
public class WaitingCommissionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WaitingCommissionAdapter(Context context, MouldList<CommissionList2B> list) {
        mContext = context;
        this.list = list;
