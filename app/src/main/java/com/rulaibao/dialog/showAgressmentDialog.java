 ...
 * 首页协议弹框 dialog
 */
public class showAgressmentDialog extends Dialog implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public showAgressmentDialog(Context context, OnExitChanged onChanged, String info) {
    ...
    private void initView(View mView) {
        ...
        txtInfo.setText(mContext.getString(R.string.agressment_info));
        ...
        tv_title.setText("服务协议及隐私政策");

        SpannableString agreement = new SpannableString("如您同意《如来保会员服务协议》和《隐私政策》，请点击“同意”后使用我们的产品和服务，我们依法全力保护您的个人信息安全。");
