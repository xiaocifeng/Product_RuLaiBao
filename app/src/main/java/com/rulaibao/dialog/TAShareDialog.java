 ...
 * 天安产品分享弹框
 */
public class TAShareDialog extends Dialog implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener{
	...
	public TAShareDialog(Context context, OnShare onChanged) {
	...
	void initData() {
		//图标
		int icno[] = {R.mipmap.ssdk_oks_classic_wechatmoments, R.mipmap.ssdk_oks_classic_wechat};
		//图标下的文字
		String name[] = {"微信朋友圈", "微信好友"};
