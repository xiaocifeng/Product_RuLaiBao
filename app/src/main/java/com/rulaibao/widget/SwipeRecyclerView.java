...
import com.rulaibao.widget.footerView.BaseFooterView;
import com.rulaibao.widget.footerView.SimpleFooterView;
...
public class SwipeRecyclerView extends FrameLayout
    ...
    private void setupSwipeRecyclerView() {
        ...
        recyclerView.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(childCount > 1 && lastVisiablePosition == childCount){
    ...
    private class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public int getItemCount() {
            ...
            return isLoadMoreEnable ? count  : count;
        }
