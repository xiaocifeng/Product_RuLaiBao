...
package com.rulaibao.widget.bankwheel;
...
import com.rulaibao.widget.bankwheel.adapters.WheelViewAdapter;
...
//	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0xeaffffff, 0x33ffffff };
	private static final int[] SHADOWS_COLORS = new int[] { 0x66ffffff, 0x66ffffff, 0x66ffffff };
...
//		int height = (int) (1.5 * getItemHeight());
		int height = (int) (1.7 * getItemHeight());
