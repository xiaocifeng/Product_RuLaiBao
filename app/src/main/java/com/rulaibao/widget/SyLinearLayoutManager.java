...
public class SyLinearLayoutManager extends LinearLayoutManager {
	...
	private final int[] childDimensions = new int[getItemCount()];
	...
	private int[] mMeasuredDimension = new int[]{};
	...
	public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
		...
		int[] mMeasuredDimension = new int[getItemCount()];
...
//        super.measureChildWithMargins(view, 0, 0);
		...
		if (view != null) {
			...
			/*for (int i = 0; i < getItemCount(); i++) {
				measuredDimension[i] = view.getMeasuredWidth() + p.leftMargin + p.rightMargin;
				measuredDimension[i] = view.getMeasuredHeight() + p.bottomMargin + p.topMargin;
			}*/
